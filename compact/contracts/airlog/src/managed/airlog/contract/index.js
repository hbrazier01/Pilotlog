...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      anchorEntry: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`anchorEntry: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const recordHash_0 = args_1[1];
        const anchoredAt_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('anchorEntry',
      ...
      getEntry: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`getEntry: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const entryId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getEntry',
                                     'argument 1 (as invoked from Typescript)',
                                     'airlog.compact line 73 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      getNextEntryId: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`getNextEntryId: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getNextEntryId',
                                     'argument 1 (as invoked from Typescript)',
                                     'airlog.compact line 81 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('anchorEntry', new __compactRuntime.ContractOperation());
  ...
  _anchorEntry_0(context, partialProofData, recordHash_0, anchoredAt_0) {
    ...
    const id_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                           partialProofData,
                                                                           [
                                                                            { dup: { n: 0 } },
                                                                            { idx: { cached: false,
                                                                            ...
                                                                            { push: { storage: false,
                                                                                      value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(COUNTER_KEY_0),
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('airlog.compact line 65 char 54: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(id_0 + 1n);
    __compactRuntime.queryLedgerState(context,
