...
function renderDashboard() {
  ...
  // Curated primary progression metrics — max 7, guided experience only.
  // Advanced FAA requirements (longSoloXC, dualPrepMonths, soloControlledAirport,
  // nightXCHours, dualXC) are excluded from this strip entirely — they surface
  // through pilot-report, whats-next, and FAA detail views.
  ...
  // Fallback for post-PPL readiness which uses different key names (soloReadiness etc.)
